...
<section>
    <div class="hero-slider position-relative">
      <div class="hero-slider-item py-160" style="background-image: url({{ asset('/') }}website/images/blog-1.jpg);"
      ...
      <div class="hero-slider-item py-160" style="background-image: url({{ asset('/') }}website/images/blog-2.jpg);"
      ...
      <div class="hero-slider-item py-160" style="background-image: url({{ asset('/') }}website/images/blog-1.jpg);" data-icon="ti-money"
        data-text="Finance">
        <div class="container">
          <div class="row">
            <div class="col-12">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 text-center">
          ...
          <h2 class="section-title section-title-border">Latest Recent Blogs</h2>
        </div>
        <!-- service item -->
  ...
  <section class="about section-sm overlay" style="background-image: url({{ asset('/') }}website/images/bkog-1.jpg);">
      <div class="container">
          <div class="row">
  ...
  <!-- promo-video -->
  <section class="promo-video overlay section" style="background-image: url({{ asset('/') }}website/images/blog-2.jpg);">
    <div class="container">
      <div class="row">
        <div class="col-12">
